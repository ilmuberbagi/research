	<style>
		...
		.heading td{font-size:3em; font-weight:bold; color:#222;}
	...
	<table>
		<tr class="heading">
			...
			<td width="50px">&nbsp;</td>
			<td width="686px"><br/><br/>DATA PUBLIKASI FAKULTAS TEKNIK <div class="small">UNIVERSITAS INDONESIA</div></td>
		</tr>
	</table><br/><br/>
	<table class="list" cellpadding="2">
		...
		<tr>
			...
			<th rowspan="2" width="20px"><br/><br/>Status Uplaod SIDR</th>
			<th rowspan="2" width="30px"><br/><br/>Verifikasi SIDR</th>
			<th colspan="<?php echo count($types);?>" width="<?php echo (count($types)*20);?>px" class="big">Jenis Publikasi/Karya</th>
			<th rowspan="2" width="100px"><br/><br/>Detail Karya Ilmiah (Penerbit,Tahun Terbit, Vol, Hal, dll)</th>
		...
		<tr style="background:<?php echo $bg;?>">
			...
			<?php } ?>
			<td valign="top" width="100px"><?php echo $a['detail'];?></td>
